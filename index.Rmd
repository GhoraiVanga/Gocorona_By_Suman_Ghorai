...
df=KIT_Data1
p=plotly::plot_ly(df ,
                  x =df$states_tested_data.state  , 
                  y = df$states_tested_data.totaltested, 
                  # text =  ~ confirmed, 
                  # textposition = 'auto',
                  type = "bar", 
                  name = "totaltested",
                  marker = list(color = active_color)) %>%
   plotly::add_trace(y = df$states_tested_data.positive, 
                    # text =  ~ death, 
                    # textposition = 'auto',
                    name = "positive",
                    marker = list(color = death_color)) %>%
  plotly::layout(barmode = 'stack',
                 yaxis = list(title = "Total Cases (log scaled)",
                              type = "log"),
                 xaxis = list(title = "",categoryorder = "array",
                              categoryarray=df$states_tested_data.state),
